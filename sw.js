const CACHE_NAME='jungle-coin-rush-v6';
const ASSETS=['./','./index.html','./style.css?v=20260909b','./game.js?v=20260909b','./demo-ads.js?v=20260909b','./purchase.js?v=20260909b','./manifest.json','./icon.svg'];
