const CACHE_NAME='jungle-coin-rush-v7';
const ASSETS=['./','./index.html','./style.css?v=20260909c','./game.js?v=20260909c','./purchase.js?v=20260909c','./demo-ads.js?v=20260909c','./manifest.json','./icon.svg'];
